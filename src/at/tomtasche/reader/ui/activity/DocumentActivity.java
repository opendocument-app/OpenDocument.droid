...
public class DocumentActivity extends SherlockFragmentActivity implements
	...
	pageFragment = (PageFragment) getSupportFragmentManager().findFragmentByTag(
		PageFragment.FRAGMENT_TAG);
	if (pageFragment == null) {
	    pageFragment = new PageFragment();
	    getSupportFragmentManager().beginTransaction()
		    .add(R.id.document_container, pageFragment, PageFragment.FRAGMENT_TAG).commit();
	...
	if (uri.toString().endsWith(".odt") || uri.toString().endsWith(".ods")
		|| uri.toString().endsWith(".ott") || uri.toString().endsWith(".ots")
		|| uri.toString().endsWith(".odp") || uri.toString().endsWith(".otp"))
    ...
    public void showCrouton(int resId, final Runnable callback, AppMsg.Style style) {
	showCrouton(getString(resId), callback, style);
    }

    public void showCrouton(String message, final Runnable callback, AppMsg.Style style) {
