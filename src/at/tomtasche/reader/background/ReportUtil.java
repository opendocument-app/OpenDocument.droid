...
public class ReportUtil {
    ...
    public static void submitFile(final Context context, final Throwable error, final Uri uri,
	...
	builder.setNeutralButton(R.string.dialog_error_send_error_only, new OnClickListener() {
		...
		context.startActivity(ReportUtil.createFeedbackIntent(context, error));
	    }
	});
	builder.setPositiveButton(android.R.string.yes, new OnClickListener() {
		...
		bundle.putString(Intent.EXTRA_SUBJECT, "OpenDocument Reader (" + version
			+ "): Error occurred");
		...
		printer.println("- " + Build.MODEL + " running Android " + Build.VERSION.SDK_INT);
