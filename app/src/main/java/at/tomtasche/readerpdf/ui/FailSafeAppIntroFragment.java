...
public class FailSafeAppIntroFragment extends AppIntroBaseFragment {
     ...
     * @return AppIntroFragment created instance
     */
    public static AppIntroBaseFragment newInstance(@NonNull SliderPage sliderPage) {
        AppIntroBaseFragment slide = new FailSafeAppIntroFragment();
