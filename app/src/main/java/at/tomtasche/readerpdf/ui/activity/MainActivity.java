...
import at.tomtasche.readerpdf.BuildConfig;
import at.tomtasche.readerpdf.R;
import at.tomtasche.readerpdf.background.KitKatPrinter;
import at.tomtasche.readerpdf.nonfree.AdManager;
import at.tomtasche.readerpdf.nonfree.AnalyticsManager;
import at.tomtasche.readerpdf.nonfree.BillingManager;
import at.tomtasche.readerpdf.nonfree.CrashManager;
import at.tomtasche.readerpdf.nonfree.HelpManager;
import at.tomtasche.readerpdf.ui.SnackbarHelper;
import at.tomtasche.readerpdf.ui.FindActionModeCallback;
import at.tomtasche.readerpdf.ui.TtsActionModeCallback;
import at.tomtasche.readerpdf.ui.widget.RecentDocumentDialogFragment;
...
public class MainActivity extends AppCompatActivity implements DocumentLoadingActivity {
    ...
    private void initializeProprietaryLibraries() {
        ...
        billingManager.setEnabled(false);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_fullscreen: {
                if (fullscreen) {
                    ...
                    if (!billingManager.hasPurchased() && adManager.isShowAds()) {
