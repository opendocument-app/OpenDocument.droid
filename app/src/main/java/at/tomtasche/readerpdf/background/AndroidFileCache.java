...
public class AndroidFileCache extends DefaultFileCache {
        ...
        public URI translate(File file) {
            ...
            try {
                result = new URI(
                        ...
                        // "content://at.tomtasche.readerpdf/" +
    ...
    public static Uri getCacheFileUri() {
        // hex hex!
        return Uri.parse("content://at.tomtasche.readerpdf/document.odt");
    }

    public static Uri getHtmlCacheFileUri() {
        // hex hex!
        return Uri.parse("content://at.tomtasche.readerpdf/content.html");
    }
